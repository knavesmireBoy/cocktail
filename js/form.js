...
(function (mq, query) {
	...
	function post(e) {
        ...
        if(is_touch_enabled()) {
            ...
            if(!$('comb_bound')){
                doComp(ptL(setAttrs, comb_bound), anCr( doComp(getEl, exec, eventer, ptL(setAttrs, {id: 'comb_bound'}), anCrIn(e.target.parentNode.nextSibling, e.target.parentNode.parentNode))('a')))('img');
            }
            else {
