...
<?php include '../templates/footer.php';     
    ...
    <script>
        ...
        //previously a list of numbers, we need to have the extension present to differentiate from 'jpg' AND 'jpeg' files
        //img_dir = <?php echo json_encode(sortArray(trimString($iZero, 1, 2))) ?>;
        img_dir = <?php echo json_encode($iZero) ?>;
    </script>
