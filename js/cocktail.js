...
(function (mq, query, callbacks, pass, shown, hidden) {
	...
	var instr = {
			...
			daiquiri: [
				["Shake with cracked ice.", "Strain into a chilled cocktail glass.", "Garnish with a lime wheel."],
				["<a href='.'>Daiquiri</a>", "1½ oz light rum", "¾ oz lime juice", "¼ ounce of simple syrup", "<b>Cocktail Glass</b>"],
