...
window.speakEasy.SimpleXhrFactory = (function () {
    "use strict";
	// The three branches.
	var standard = {
...
window.speakEasy.Hijax = function () {
    /*
    ...
    */
	...
	function captureDataOnClick(flag) {
		...
		} else if (container.nodeName.toLowerCase() === 'form' && !flag) {
	...
	function start() {
		request = speakEasy.SimpleXhrFactory.createXhrObject();
		if (!request || !url) {
			return false;
		} else {
			initiateRequest();
